...
class Resume extends React.Component { 
  render() {
    return (
      <Container fluid className="full-width bg-spots-blask">
        ...
        <Row className="my-5 vh-70 justify-content-center">          
          <Col sm={12} md={5} className="bg-pink-one rounded-left text-white p-4">
            <h3>2017 - 2020</h3>
        ...
        <Row className="my-5 vh-70 justify-content-center">
          <Col sm={12} md={5} className="bg-pink-one rounded-left p-4 text-white">
            <h3>2012 - 2015</h3>
            <h1 className="title-md">KANDIDAT&shy;EXAMEN <br/>I INFORMATIK</h1>
        ...
        <Row className="my-5 vh-70 justify-content-center">
          <Col sm={12} md={5} className="bg-pink-two rounded-left p-4">
